...
//! threshold matches [`brigid_core::DEFAULT_BATCH_CHAR_BUDGET`] (80 000 bytes)
...
/// [`brigid_core::DEFAULT_BATCH_CHAR_BUDGET`] — if all file bodies fit in one
...
mod tests {
    ...
    fn temp_dir() -> std::path::PathBuf {
        ...
        let dir = std::env::temp_dir().join(format!("brigid-identify-ckpt-{n}-{seq}"));
