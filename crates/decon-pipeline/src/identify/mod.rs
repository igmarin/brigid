...
/// Enrich empty `kind` fields in an [`decon_core::IdentifyResult`] using a
/// [`decon_core::plugin::PluginRegistry`].
///
...
///
/// [`KindDetector`]: decon_core::plugin::KindDetector
/// [`DefaultKindDetector`]: decon_core::plugin::DefaultKindDetector
/// [`PluginRegistry::with_default`]: decon_core::plugin::PluginRegistry::with_default
pub fn enrich_identify_kinds(
    result: &mut decon_core::IdentifyResult,
    files: &[String],
    contents: &[String],
    registry: &decon_core::plugin::PluginRegistry,
) {
    decon_core::plugin::enrich_abstraction_kinds(
...
mod enrich_tests {
    use super::*;
    use decon_core::plugin::{KindDetector, PluginRegistry};
    use decon_core::{Abstraction, AbstractionKind, IdentifyResult, Tier};
