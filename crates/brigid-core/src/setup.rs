...
///
/// ```
/// use brigid_core::setup::assess_setup;
///
/// let readme = "\
/// # Lib\n\n## Prerequisites\n\nRequires Rust 1.85.\n\n\
/// ## Install\n\n```bash\ncargo install --path .\n```\n\n\
...
mod tests {
    ...
    // Paths are relative to this source file (`crates/brigid-core/src/setup.rs`).
    ...
    fn assess_setup_python_lib_matches_baseline() {
        ...
        assert_eq!(a.signals.readme_length, 502);
    ...
    fn assess_setup_umbrella_matches_baseline() {
        ...
        assert!(!a.needs_setup_guide);
        assert_eq!(a.score, 100);
        assert_eq!(a.signals.readme_length, 541);
        assert!(a.gaps.is_empty());
        assert_eq!(
            a.config_files,
            vec![
    ...
    fn assess_setup_js_lib_matches_baseline() {
        ...
        assert!(!a.needs_setup_guide);
        assert_eq!(a.score, 100);
        assert_eq!(a.signals.readme_length, 381);
        assert!(a.gaps.is_empty());
        assert_eq!(
            a.config_files,
