...
///
/// ```
/// use brigid_core::budget::{truncate_content, TRUNCATION_MARKER};
///
...
///
/// ```
/// use brigid_core::budget::{path_stub, PATH_STUB_PREFIX};
///
...
///
/// ```
/// use brigid_core::budget::{estimate_budget, BudgetConfig, FileSize};
