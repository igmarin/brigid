...
///
/// ```
/// use brigid_core::mermaid::sanitize_label;
///
...
///
/// ```
/// use brigid_core::mermaid::stable_node_id;
///
...
///
/// ```
/// use brigid_core::mermaid::participant_line;
///
/// assert_eq!(
...
///
/// ```
/// use brigid_core::mermaid::validate_mermaid;
///
...
///
/// ```
/// use brigid_core::mermaid::{sanitize_mermaid, validate_mermaid};
///
...
///
/// ```
/// use brigid_core::mermaid::sanitize_markdown_mermaid_blocks;
///
/// let md = "Intro\n\n```mermaid\nflowchart LR\n  A0[Ok]\n```\n";
